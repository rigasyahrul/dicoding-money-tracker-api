...
const connection = mysql.createConnection({
    socketPath: '/cloudsql/syahrigasyahrul-rigasyahrul:asia-southeast2:money-tracker-db',
    user: 'root',
    database: 'dicoding_cloud_engineer',
    password: 'sDxAg5z4uoXyW1ahDfPY3jRA67DFecO5',
})
